...
p2 <- msaplot(variant_heatmap, fasta = file.path(project_dir,"hpc1_nice_labels.fasta"), offset=0.05, width=0.6) +
  theme(legend.position = "none")
ggsave(p2, file= file.path(project_dir,"hpc1_tree_alignment.png"), height=12, width=9, units = "in")
...
cat("├── hpc1_donor_all_samples.pdf         # Output: Full tree visualization with variant heatmap\n")
